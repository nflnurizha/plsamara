                        ...
                        <div class="login-form">
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="username" class="au-input au-input--full {{ $errors->has('username') ? ' is-invalid' : '' }}" type="username" name="username" placeholder="Username" value="{{ old('username') }}" required autofocus>
